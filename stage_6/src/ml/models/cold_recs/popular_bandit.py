"""
Class for handling cold recos using pretrainded Popular and MAB models
"""
...
class PopularBanditRecommender:  # pylint: disable=R0903
    """
    ...
    def predict(  # pylint: disable=R0914
        self,
        ...
        if pre_gen_recs:
            ...
            for n in tqdm(range(pre_gen_n)):
                try:
                    ...
                    cur_recs["mab_rank"] = list(range(1, self.mab_model.top_k + 1))
