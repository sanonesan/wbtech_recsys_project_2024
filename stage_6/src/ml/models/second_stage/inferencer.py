...
class Inferencer:
    ...
    def inference_catboost_model(
        ...
        Args:
            ...
            ranker_data (str): Path to the specific ranking data. This path will be added to the `data_path`.
            ...
            n_splits (int, optional): Number of splits for parallel processing or inference. Defaults to 1.

        Returns:
            Any: The rearranged candidates returned by the `cb_ranker_model.get_rearranged_candidates()` method.
        """
